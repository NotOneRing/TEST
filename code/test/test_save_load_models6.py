...
for epoch in range(3):  # train 3 epochs
    ...
    for step in range(1):  # iterate data (this is the simplified version)
        with tf.GradientTape() as tape:
            ...
            loss = mse_loss_fn(y_train, predictions)  # calculate loss using MSE
...
loss1 = mse_loss_fn(y_train, outputs_original)  # calculate loss

outputs_loaded = loaded_model_a(x_train)
loss2 = mse_loss_fn(y_train, outputs_loaded)  # calculate loss

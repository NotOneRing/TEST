...
def make_dataset(
    ...
    print("filter_d3il_avoid_data.py: make_dataset()")
    ...
    def check_mode(x):
        ...
        print("filter_d3il_avoid_data.py: check_mode()")
    ...
    def plot(out, name):
        print("filter_d3il_avoid_data.py: plot()")

        def get_obj_xy_list():

            print("filter_d3il_avoid_data.py: get_obj_xy_list()")
...
if __name__ == "__main__":
    ...
    print("filter_d3il_avoid_data.py: main()")

        ...
        while self.itr < self.n_train_itr:
            ...
            if not eval_mode:
                ...
                for _ in range(num_batch):
                    ...
                    self.critic_v_optimizer.apply_gradients(zip_gradients_critic_v_params)
                    ...
                    zip_gradients_critic_q_params = zip(tf_critic_q_gradients, self.model.critic_q.trainable_variables)
                    self.critic_q_optimizer.apply_gradients(zip_gradients_critic_q_params)
